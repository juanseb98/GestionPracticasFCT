 ...
 * implementation (version 2.3.7). See
 * <a href="http://iharder.net/base64">http://iharder.net/base64</a> for more
 * information.
 * <p>
...
public final class Base64 {
	 ...
	 * .org/rfcs/rfc3548.html</a>. It is important to note that data encoded this
	 * way is <em>not</em> officially valid Base64, or at the very least should not
	 * be called Base64 without also specifying that is was encoded using the URL-
